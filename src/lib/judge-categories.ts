...
export const CATEGORY_HIERARCHY: CategoryGroup[] = [
  ...
  { major: "피부",      judgeLabel: "피부",          subs: ["바디관리(다리)", "바디관리(복부)", "바디관리(등)", "살롱테크닉", "페이스관리", "근막테라피"] },
  ...
  { major: "헤어",      judgeLabel: "헤어",          subs: ["펌와인딩(9등분)", "펌와인딩(혼합형)", "원랭스(스파니엘)", "원랭스(이사도라)", "원랭스(그래듀에이션)", "원랭스(레이어드)", "살롱헤어커트", "살롱헤어커트(맨즈컷)", "블로드라이", "롤세팅", "업스타일", "고전머리", "붙임머리"] },
  // 이용(이발) — 이용사 국가기술자격 실기 과제 기반
  // 실기 과제: 상고형커트, 중상고형커트, 아이론웨이브, 면도 등
  { major: "이용",      judgeLabel: "이용",          subs: ["이용(중상고)", "이용(아이론(6mm))", "이용(아이론(12mm))", "이용(상고)", "이용(투블록)"] },
