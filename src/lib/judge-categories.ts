...
export const CATEGORY_HIERARCHY: CategoryGroup[] = [
  ...
  { major: "헤어",      judgeLabel: "헤어",          subs: ["펌와인딩(9등분)", "펌와인딩(혼합형)", "원랭스(스파니엘)", "원랭스(이사도라)", "원랭스(그래듀에이션)", "원랭스(레이어드)", "살롱헤어커트", "살롱헤어커트(맨즈컷)", "블로드라이(인컬)", "블로드라이(아웃컬)", "블로드라이", "롤세팅", "업스타일", "고전머리", "붙임머리"] },
  // 이용(이발) — 이용사 국가기술자격 실기 과제 기반
  // 실기 과제: 상고형커트, 중상고형커트, 아이론웨이브, 면도 등
  { major: "이용",      judgeLabel: "이용",          subs: ["이용(중상고)", "이용(아이롱(6mm))", "이용(아이롱(12mm))", "이용(하상고)", "이용(투블록)"] },
