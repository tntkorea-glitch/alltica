...
const MATCH_RULES: MatchRule[] = [
  ...
  { pattern: /블로드라이|롤세팅/, key: "헤어스타일" },
  { pattern: /원랭스|펌와이딩/, key: "헤어커트" },
  { pattern: /고전머리|붙임머리/, key: "헤어작품" },
  { pattern: /플라즈마/, key: "플라즈마" },
  // 상위 종목 (넓은 매칭)
  { pattern: /반영구|pmu|퍼머넌트/, key: "pmu" },
  { pattern: /smp|두피마이크로|두피문신/, key: "smp" },
  { pattern: /네일|nail/, key: "선마블" }, // 네일 기본값 = 선마블
  { pattern: /메이크업|makeup/, key: "뷰티메이크업" }, // 메이크업 기본값 = 뷰티
